...
🛠️ Stack Tecnológica
<table> <tr> <td><strong>Linguagem</strong></td> <td>Python 3.x</td> </tr> <tr> <td><strong>Bibliotecas</strong></td> <td>Pandas, Matplotlib, Seaborn, pandasql</td> </tr> <tr> <td><strong>Banco de Dados</strong></td> <td>SQL (via SQLite)</td> </tr> <tr> <td><strong>Ambiente</strong></td> <td>Google Colab</td> </tr> </table>
📁 Estrutura do Projeto
text
project/
│
├── 📓 globalvision_analysis.ipynb      # Notebook principal
├── 📊 accounts_anonymized.json         # Dados de contas
├── 📈 support_cases_anonymized.json    # Dados de casos
